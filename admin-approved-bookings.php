...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h1 class="text-center"><span class="fa fa-ticket"></span> Approved Bookings</h1>
			<hr>
		</div>
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tbody class="mdb-color text-white">
					...
					<?php
						$disp_bookings = "SELECT * FROM booking INNER JOIN services USING(ServiceID) INNER JOIN users USING(UsersID) WHERE Status = 'Approved' ORDER BY DateBooked DESC";
					...
					<?php	} else {
                            ...
                            <span class='fa fa-info-circle'></span> No Approved Services Found</h3></td></tr>";
						} ?>
				</tbody>
			</table>
		</div>
